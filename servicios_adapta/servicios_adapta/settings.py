"""
Django settings for servicios_adapta project.
...
SECRET_KEY = 'django-insecure-h6t*=3_0q29_dn$x=-$ai09-1+$27axan58qsrb1(s^5m1+oa@'
...
ROOT_URLCONF = 'servicios_adapta.urls'
...
WSGI_APPLICATION = 'servicios_adapta.wsgi.application'
